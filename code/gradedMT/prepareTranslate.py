...
if __name__ == '__main__':
	pass
	from config import DATA_PATH, JSON_FILE_FORMAT
	from common import getSaveFunc
	from read.UMLS.ReadMrConso import readMRCONSO_RRF
	sourcePath = DATA_PATH+'/umlsMT/umls/MRCONSO.RRF'
	...
	saveAsJson = getSaveFunc(JSON_FILE_FORMAT)
	saveAsJson(AUIList, DATA_PATH+'/umlsMT/translate/AUI.json')
	saveAsJson(termList, DATA_PATH+'/umlsMT/translate/termENG.json')
	print('done')
